...
- **ต่ออายุ session ของ SchoolOS ให้ทุก 10 นาทีระหว่างที่ยังใช้งานอยู่จริง** — SchoolOS
  ไม่นับการใช้งานในระบบเราเป็น activity (§4.10 จงใจ) ถ้าไม่ต่อให้ ครูที่นั่งทำงานในนี้เกิน
  30 นาทีจะหลุดจาก SchoolOS เงียบ ๆ แล้วรอบหน้าต้องกรอกรหัสใหม่ทั้งที่เพิ่งใช้งานอยู่แท้ ๆ
- **ไม่**ดึงกลับเข้าระบบอัตโนมัติหลัง**เพิ่ง**ถูกเตะออกเพราะหมดเวลา (idle/token หมดอายุ) —
  ...
  · นับเฉพาะ "เพิ่งโดน" (ภายใน 30 นาที) เท่านั้น — ไม่ใช่ "เคยโดนเมื่อไหร่ก็ได้"
