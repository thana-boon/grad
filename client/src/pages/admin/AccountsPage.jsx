        ...
        <div className="alert alert-warning anim-scale-in mb-4">
          ...
          <div className="min-w-0 flex-1 text-sm">
            ...
            <p className="mt-0.5 text-xs opacity-80">
              เมื่อเพิ่มครูคนแรกเข้ารายชื่อ ระบบจะเริ่มกันครูที่ไม่อยู่ในรายชื่อทันที
              — ยกเว้นผู้ดูแล (teacher-admin) ของ SchoolOS ที่เข้าได้เสมอ จึงไม่มีทางล็อกตัวเองออก
            </p>
          </div>
        </div>
      )}
